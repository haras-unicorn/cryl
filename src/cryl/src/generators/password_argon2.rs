...
mod tests {
  ...
  fn test_generate_password_argon2() -> anyhow::Result<()> {
    ...
    generate_password_argon2(&public_path, &private_path, 16, true)?;
  ...
  fn test_generate_password_argon2_length() -> anyhow::Result<()> {
    ...
    for length in [8, 12, 24, 32] {
      ...
      generate_password_argon2(&public_path, &private_path, length, true)?;
  ...
  fn test_generate_password_argon2_no_overwrite_without_renew(
    ...
    generate_password_argon2(&public_path, &private_path, 16, false)?;
